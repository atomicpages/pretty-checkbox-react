...
import { CommonProps, CommonCheckboxRadioProps } from '../types/CommonProps';

export const isBoolean = (value?: any) => typeof value === 'undefined';

export const getChecked = (
    args: Pick<CommonProps<any>, 'disabled' | 'locked' | 'state' | 'value' | 'type'>
) => {
...
export const isDefaultStyle = (
    animation: CommonCheckboxRadioProps['animation'],
