...
const ManualControlRadio = () => {
    ...
    return (
        <>
            <Radio name="malcom" value="yes" onChange={onChange} checked={state == 'yes'}>
                Yes
            </Radio>
            <Radio name="malcom" value="no" onChange={onChange} checked={state == 'no'}>
                No
            </Radio>
            <Radio name="malcom" value="idk" onChange={onChange} checked={state == 'idk'}>
                I don't know
            </Radio>
